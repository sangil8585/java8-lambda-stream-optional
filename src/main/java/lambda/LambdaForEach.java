...
public class LambdaForEach {
    ...
    public void run() {
         ...
         *
         * for문과 forEach에서 출력한 결과 값은 같다.
         * forEach은 람다식으로 표현하기 때문에 소스도 간결하게 작성할 수 있다.
         */
         ...
         * author : byun sangil
         * date : 2022-07-06
         * description : List forEach 사용방법
         * indexOf 함수를 사용하여 인덱스 번호로 List에서 요소를 취득하여 출력함.
         * List값을 출력할 때는 lambda식을 생략하여 작성할 수 있다.
         */
        ...
        list2.forEach(s -> System.out.println(list2.indexOf(s) + " : " + s));
        list2.forEach(System.out::println); //람다식 생략 예제
    }
